...
var fixed =  document.querySelector("#fixed-image")
    ...
    // this code for displaying the image
    //here the elem1 is the div  in html
    // data-image here is the attribute of html
    ...
    //here  the .elem is the class of html
    ...
    var swiper = new Swiper(".mySwiper", {
      ...
      const savya = new LocomotiveScroll({
        el:document.querySelector("#main"),
        smooth: true,
        lerp: 0.02
      })
